...
- **1.6.1 is the canonical, working version of this fork.** It is what runs in the live game, and this folder is the live install (a git worktree on the `1.6.1` branch). Treat the `1.6.1` branch (and the `v1.6.1` tag) as the source of truth for shipping changes.
